...
export class PointDeVue {
    ...
    constructor(public tag: string, public depart: number, public fin: number, public color: string) {
    ...
    isReady() {
        ...
        let videoReady = (this.video.readyState >= readyStateMin || this.video.currentTime === this.video.duration);
